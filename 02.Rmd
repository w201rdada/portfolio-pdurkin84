...
While experiencing a disease that causes loss of voice is never going to be pleasant, this solution could have a groundbreaking psychological impact as it means that the sufferer does not end up isolated in the last few months or years of their life.  Also, it lends itself to future innovations such as brain-computer interface (BCI), which could then be leveraged to directly utilize the system, or even record the brain waves during healthy periods of speech.
