...
For anyone choosing to invest in frontier and emerging economies, there is a risk due to the governments of these nations being suspect in the statistical data they publish.  We will provide a second calculation for some of the crucial economic numbers to support or refute those of the government so that investors can feel more comfortable about their choice to invest or not.

### Abstract of my second cool idea


Anyone suffering from a degenerative neurological disease is going to lose their voice eventually, however, we can build a tool to reduce the impact of this.  Using a combination of existing technologies, we can build a solution that uses recordings of the person's own voice to enhance their fading voice.
